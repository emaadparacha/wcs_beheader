...
if args.mode == 'wcs' or args.mode == 'all':
    ...
    with open('files_not_complete_downsample_6.txt', 'w') as f:
        for file in files_not_complete:
            f.write(file + '\n')
...
if args.mode == 'siptotpv' or args.mode == 'all':
    ...
    if os.path.exists('files_not_complete_downsample_6.txt'):
        with open('files_not_complete_downsample_6.txt', 'r') as f:
